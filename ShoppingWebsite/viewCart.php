...
if (!empty($_SESSION['cart'])) {
	...
	<div align="right"><input type="image" name="submit" src="images/updateCart.jpg" alt="Update My Cart" width="70" height="50"/></div>
	</form><p align="right">Enter a quantity 0 to remove an item.</p>
	<br /><br /><p align="center"><a href="shipping.php"><img src="images/checkOut.jpg" width="100" height="40"/></a></p>';
